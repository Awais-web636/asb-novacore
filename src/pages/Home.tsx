...
import { ArrowRight, Zap, Users, Trophy, Star } from 'lucide-react';
...
const Home = () => {
  ...
  const features = [
    ...
    },
    {
      ...
      description: 'Rigorous testing and quality assurance for all our deliverables',
    },
    {
      ...
      <section className="min-h-screen flex items-center justify-center relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
          ...
          >
            ...
            mobile apps, WordPress solutions, and stunning UI/UX design.
          </motion.p>
          ...
          >
            <Link
              to="/services"
              className="bg-gradient-to-r from-cyan-500 to-purple-600 text-white px-8 py-4 rounded-lg text-lg font-semibold hover:from-cyan-600 hover:to-purple-700 transition-all duration-300 transform hover:scale-105 inline-flex items-center justify-center cursor-pointer"
            >
              Explore Services
            ...
            <Link
              to="/portfolio"
              className="border-2 border-cyan-400 text-cyan-400 px-8 py-4 rounded-lg text-lg font-semibold hover:bg-cyan-400 hover:text-white transition-all duration-300 transform hover:scale-105 cursor-pointer"
            >
              View Portfolio
            </Link>
          </motion.div>
